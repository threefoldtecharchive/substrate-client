	...
	validNode = Node{
		...
		PublicConfig: OptionPublicConfig{
			...
			AsValue: PublicConfig{
				IP4: IP{
					IP: "185.206.122.31/24",
					GW: "185.206.122.1",
				},
				IP6: OptionIP{
					HasValue: true,
					AsValue: IP{
						IP: "2a10:b600:1::0cc4:7a30:65b5/64",
						GW: "2a10:b600:1::1",
					},
				},
				Domain: OptionDomain{
					HasValue: true,
					AsValue:  "gent01.dev.grid.tf",
				},
			},
		},
		Created:       1649252280,
		...
		Interfaces: []Interface{
			{
				Name: "zos",
				Mac:  "0c:c4:7a:30:7a:68",
				IPs:  []string{"10.9.0.113", "2a10:b600:0:9:ec4:7aff:fe30:7a68"},
			},
		},
